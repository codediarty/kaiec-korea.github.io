...
def build_expert():
    ...
    body = f"""    <section class="page-hero">
      <div class="wrap page-hero-inner" style="padding-block:78px 72px">
        ...
        <p class="ph-lead">2026년, 가장 빠르게 떠오르는 스펙.<br>
           기업과 기관, 학교가 지금 가장 급하게 찾는 <b class="t">AI윤리전문가</b>.</p>
        <p class="ph-body">AI기본법 시행으로 조직마다 AI 활용 기준을 세울 사람이 필요해졌습니다.
           위원회 표준교재로 공부하고 온라인 이수 평가 하나면 끝. 이수와 동시에 위원회 <strong>공식 등록</strong>, 이력서에는 공식 이수증 한 줄.<br>
           <b>1기 특별가 {won(PRICE_L2)}부터 · 연 {QUOTA}명 한정 · 접수 마감 {DEADLINE}</b></p>
        ...
        <div style="display:flex;gap:11px;flex-wrap:wrap;margin-top:26px">
          ...
          <a class="btn btn-light" href="#course">1기 특별가 보기</a>
          <a class="btn btn-light" href="quiz.html">AI 윤리 실무 진단</a>
        </div>
      </div>
    </section>
      ...
      <div class="gform-wrap">
        ...
        <form id="examForm" novalidate>
          ...
          <div class="gform-card" id="secRefund">
            ...
            <p class="field-hint" style="margin-top:14px">자세한 내용은 <a href="terms.html#refund" style="color:var(--blue);font-weight:700">서비스 이용안내</a>에서 확인하실 수 있습니다.</p>
          </div>
